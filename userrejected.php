...
<body>
  <form action="userrejected.php" method="post">
<div style="margin-left:16%;padding:1px 16px;height:1000px;">
<h2>REJECTED WORK RECORD</h2>
<br>
<?php 
...
$result = mysqli_query($handle, "SELECT * FROM  booking where users='{$_SESSION['user']}' and status='Rejected'");

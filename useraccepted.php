...
$result = mysqli_query($handle, "SELECT * FROM  booking where users='{$_SESSION['user']}' and status='Accepted'");
...
echo '<table border="0" cellspacing="2" cellpadding="2"> 
  ...
  while ($row = $result->fetch_assoc()) 
  {
      ...
      echo '<tr> 
                ...
                <td>'.$field3name.'</td> 
                <td>'.$field4name.'</td>';
                // echo "<td><a class='bt' href='workaccepted.php?cmpt=".$row["bookid"]."'>COMPLETED</a></td>";
                // echo "</tr>";

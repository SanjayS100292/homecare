...
$result = mysqli_query($handle, "SELECT * FROM users where status='Accepted'");
...
echo '<table border="0" cellspacing="2" cellpadding="2"> 
  ...
  while ($row = $result->fetch_assoc()) 
  {
      ...
      echo '<tr> 
                ...
                echo "<td><a class='bt' href='adminuser.php?del=".$row["uusername"]."'>Delete</a></td>";
                echo "</tr>";
}
...
{
  $username = $_GET["del"];
  if($handle->query("DELETE FROM users WHERE username='$username'"))
  {

...
<body>
  <form action="workcomplaint.php" method="post">
...
$query="INSERT INTO complaintprovider(workid, wname,bookid,complaint,status) VALUES('$field0name','$field1name','$bookingid','$complaint','Pending')";
...
if($res)
{
  ...
  window.location.href= 'workcomplaintstatus.php'
	</script>";
}

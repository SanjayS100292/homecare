...
<tr>
  ...
  <td><textarea name="addr" id="addr" required>'.$field3name.'</textarea></br><td>
</tr>

  </table>';
  ?>
<br>
    <button type="editprofile" name="editprof" id="editprof" class="btn">Edit Profile</button><br><br>
    <br><br>
    </div>
<br>
...
{
	$sql = "UPDATE users SET email='$_POST[email]',address='$_POST[addr]' WHERE uusername='$_SESSION[user]'";
